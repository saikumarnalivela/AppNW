...
class schoolTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "schoolTVC")
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "teamlink"{
            let teamDVC = segue.destination as! teamTableViewController
            // Pass the selected object to the new view controller.
            teamDVC.school = Schools.shared[tableView.indexPathForSelectedRow!.row]
        }
